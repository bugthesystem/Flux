//! # kaos-ipc
//!
//! Inter-process communication using kaos shared memory ring buffers.
//!
//! This is a thin wrapper around `kaos::disruptor::SharedRingBuffer`, providing
...
//! ┌─────────────────┐      ┌─────────────────────┐      ┌─────────────────┐
//! │   Application   │      │  kaos SharedRingBuf │      │   Application   │
//! │       │         │      │  (mmap-backed)      │      │       │         │
//! │       ▼         │      │  ┌─┬─┬─┬─┬─┬─┬─┬─┐  │      │       ▲         │
...
mod tests {
    ...
    fn test_publisher_subscriber() {
        let path = "/tmp/kaos-ipc-wrapper-test";
    ...
    fn test_high_throughput() {
        let path = "/tmp/kaos-ipc-throughput-test";
        let _ = fs::remove_file(path);
