...
Kaos is a lock-free ring buffer library implementing the LMAX Disruptor pattern for high-throughput inter-thread communication.
...
| Type | Size | Use Case |
|------|------|----------|
| `Slot8` | 8B | Sequence only, max throughput |
